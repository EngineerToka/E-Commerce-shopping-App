...
export default function Register() {
  ...
  phone :Yup.string().required('Phone number is required').matches(/^(\+201|01|00201)[0-2,5]{1}[0-9]{8}/, 'Invalid phone number format'),
 ...
 const{values,handleChange,handleBlur,handleSubmit,errors,touched,isValid}=useFormik({
  ...
  <div className="form-group">
    ...
    <input name="phone" onChange={handleChange} onBlur={handleBlur} value={values.phone} type="tel" className="form-control" id="inputPhone" placeholder="Enter Your phone"/>
